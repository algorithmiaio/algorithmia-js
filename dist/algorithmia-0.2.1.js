(function() {
    ...
    function normalizeURL(url) {
      url = url.replace(/\/$/, '')
      const requiredPath = '/v1/web/algo'
      const pathRegex = new RegExp(requiredPath + '$')
      return pathRegex.test(url) ? url : url + requiredPath
    }
    ...
    Algorithmia.client = function(api_key, api_address) {
      ...
      api_address = normalizeURL(api_address || getDefaultApiAddress());
